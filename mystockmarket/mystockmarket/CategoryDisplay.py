...
data=a.fetchall()
for i in data:
	print("<tr><td>"+str(i[0])+"</td><td>"+str(i[1])+"</td><td><img src=myimg/"+str(i[2])+" height=100 width=100></td><td>"+str(i[3])+"</td><td><a href=CompanyDisplay.py?catid="+str(i[0])+">Company Display</a></td></tr>")
