...
data=a.fetchall()
for i in data:
	print("<tr><td>"+str(i[0])+"</td><td>"+str(i[1])+"</td><td>"+str(i[5])+"</td><td>"+str(i[6])+"</td><td><img src="+str(i[7])+" height=100 width=100></td><td>"+str(i[8])+"</td><td><a href="+str(i[9])+" target=_blank>"+str(i[9])+"</a></td><td>"+str(i[10])+"</td><td>"+str(i[11])+"</td><td><a href=ComPrice.py?comid="+str(i[5])+">Get Price</a></td></tr>")
print("</table>")
print("</center>")
print("</body>")
print("</html>")
